...
@{
    ...
    UseSharedMarainHosting = $false
    HostingEnvironmentType = "Functions"        # Valid Options: None, AppService, ContainerApps, Functions
    ...
    UseExistingAppInsightsWorkspace = $true     # When false, an AppInsights workspace will be provisioned in the default resource group
                                                # When true, uncomment the settings below to configure the details
    AppInsightsWorkspaceName = "jdtestai"
    AppInsightsWorkspaceLocation = "eastus"     # Only required if in a different location
    AppInsightsWorkspaceResourceGroupName = "jd-config-test-rg"
