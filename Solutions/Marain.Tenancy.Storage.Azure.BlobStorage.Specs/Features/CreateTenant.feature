...
Scenario: Create a child of a child of the root tenant
    ...
    When I create a child of the tenant called 'Tenant1' named 'ChildTenant2' labelled 'Tenant2'
...
Scenario: Create a child of a child with well known Ids
    ...
    When I create a well known child of the tenant called 'Tenant1' named 'ChildTenant2' with a Guid of 'DD045C05-E7FB-4214-8878-F9E7CA9B0F5F' labelled 'Tenant2'
    And I get the tenant with the id from label 'Tenant2' labelled 'Result'
    Then the tenant details labelled 'Tenant2' should match the tenant details labelled 'Result'
...
Scenario: Creating a child of a child with a well known Id that is already in use by a child of the same parent throws an ArgumentException
    ...
    When I try to create a well known child of the tenant called 'Tenant1' named 'ChildTenant3' with a Guid of 'DD045C05-E7FB-4214-8878-F9E7CA9B0F5F'
...
Scenario: Creating children that have the same well known Ids under different parents succeeds
    ...
    When I create a well known child of the tenant called 'Parent2' named 'ChildTenant4' with a Guid of '2A182D6E-FF13-4A73-87AF-0B58D8243603' labelled 'ChildOfParent2'
